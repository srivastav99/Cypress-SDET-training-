...
module.exports = defineConfig({
  ...
  e2e: {
    watchForFileChanges : false, //If we remove this or keep it ahs true every time we make a change and save our file the cypress will automatially execute the testcase
